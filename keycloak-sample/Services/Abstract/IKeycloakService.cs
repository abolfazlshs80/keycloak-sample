...
public interface IKeycloakService
{
    ...
    Task<(bool IsSuccess, string Message)> RegisterAsync(RegisterDto request, CancellationToken cancellationToken);

    Task<(bool IsSuccess, string Message)> LoginAsync(LoginDto request, CancellationToken cancellationToken);
